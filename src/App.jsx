        ...
        html: `
          <div style="font-family:monospace;max-width:560px;margin:0 auto;padding:32px;color:#111110;">
            ...
            <table style="width:100%;border-collapse:collapse;font-size:12px;">
              ...
              <tr><td style="padding:8px 0;border-bottom:1px solid #ebebea;color:#a8a8a4;">referencia</td><td style="padding:8px 0;border-bottom:1px solid #ebebea;">${ref}</td></tr>
            </table>
            ...
            <div style="margin-top:32px;padding-top:20px;border-top:1px solid #d8d6d0;font-size:11px;color:#a8a8a4;">
              Entra al panel de administración en <a href="https://xn--eltabln-q0a.com" style="color:#111110;">eltablón.com</a> para aprobar o rechazar este evento.
            </div>
          </div>
        `,
      }),
